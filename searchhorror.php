...
//select statement
$query_str = "SELECT * FROM $tblHorror WHERE horror_name LIKE '%" .$name. "%' OR movie_bio LIKE '%" .$name. "%'";
	...
	<div class="container wrapper">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="horror.php">Horror</a></li>
						...
						<div class="caption">
							<div class="text-center">
								<a href="horror_details.php?id=<?php echo $result_row['horror_id']?>">
									<img src="<?php echo $result_row['horror_img'] ?>" />
								</a>
							</div>
								...
								<p class="lead text-center"><?php echo $result_row['horror_bio'] ?></p>
						</div>
					</div>
				</div>
		<?php if ($i == 3) : ?>
