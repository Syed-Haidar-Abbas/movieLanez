...
//select statement
$query_str = "SELECT * FROM $tblAdventure WHERE adventure_name LIKE '%" .$name. "%' OR adventure_bio LIKE '%" .$name. "%'";
						...
						<div class="caption">
							<div class="text-center">
								<a href="adventure_details.php?id=<?php echo $result_row['adventure_id']?>">
									<img src="<?php echo $result_row['adventure_img'] ?>" />
								</a>
							</div>
								...
								<p class="lead text-center"><?php echo $result_row['adventure_bio'] ?></p>
						</div>
					</div>
				</div>
		<?php if ($i == 3) : ?>
