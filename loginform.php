    ...
    <div class="container wrapper">
        ...
        <div class="col-xs-6 col-xs-offset-2">
            ...
            if( isset( $_GET['ls'] ) ) {
                ...
                echo "<p class='lead text-primary'>You are not logged in. Please login or <a class='text-warning' href='registrationform.php'>create</a> a new account</p>";
            }
            ...
            if ( $login_status != 1 && $login_status != 3 ) { ?>
                <form class="form-horizontal" role="form" action="login.php" method="post">
                    ...
                    <div class="form-group sign my-3">
