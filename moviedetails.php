...
//	$review_result_row = $review_result->fetch_assoc();
	...
	$page_title = "MovieLanez: " . $result_row['movie_name'];
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page"><?php echo $result_row['movie_name'] ?></li>
		</ol>
	</nav>
		...
		<div class="col-xs-8">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<h3>Movie Genre: <?php echo $result_row['movie_genre'] ?></h3>
