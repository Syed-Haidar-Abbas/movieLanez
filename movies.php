...
if (!$result) {
	...
	<div class="container">
		...
		<nav aria-label="breadcrumb">
			...
			<h1 class="text-center">Action Movies</h1>

			<div class="row my-3">
				<div class="col-xs-4 col-xs-offset-8">
					<form action="searchaction.php" method="get" class="form-inline search-form" role="form">
				...
				<div class="col-sm-4">
					<div class="card" style="width: 18rem;">
						<a href="action_details.php?id=<?php echo $result_row['action_id']?>">
							<img src="<?php echo $result_row['action_img'] ?>" class="card-img-top" alt="..." />
						</a>
						<div class="card-body">
							<p class="card-text">
								<?php
	...
	<div class="container my-3 text-center">
		<nav class="example" aria-label="Page navigation example">
			<ul class="pagination">
				...
				<li class="page-item">
				<a class="page-link" href="adventure.php" aria-label="Next">
