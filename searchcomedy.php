...
//select statement
$query_str = "SELECT * FROM $tblComedy WHERE comedy_name LIKE '%" .$name. "%' OR comedy_bio LIKE '%" .$name. "%'";
						...
						<div class="caption">
							<div class="text-center">
								<a href="comedy_details.php?id=<?php echo $result_row['comedy_id']?>">
									<img src="<?php echo $result_row['comedy_img'] ?>" />
								</a>
							</div>
								...
								<p class="lead text-center"><?php echo $result_row['comedy_bio'] ?></p>
						</div>
					</div>
				</div>
		<?php if ($i == 3) : ?>
