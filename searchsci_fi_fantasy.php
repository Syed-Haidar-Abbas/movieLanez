...
//select statement
$query_str = "SELECT * FROM $tblSci_fi_fantasy WHERE sci_fi_fantasy_name LIKE '%" .$name. "%' OR sci_fi_fantasy_bio LIKE '%" .$name. "%'";
	...
	<div class="container wrapper">
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="sci_fi_fantasy.php">Movies</a></li>
						...
						<div class="caption">
							<div class="text-center">
								<a href="sci_fi_fantasy_details.php?id=<?php echo $result_row['sci_fi_fantasy_id']?>">
									<img src="<?php echo $result_row['sci_fi_fantasy_img'] ?>" />
								</a>
							</div>
								...
								<p class="lead text-center"><?php echo $result_row['sci_fi_fantasy_bio'] ?></p>
						</div>
					</div>
				</div>
		<?php if ($i == 3) : ?>
