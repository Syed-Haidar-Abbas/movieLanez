...
$page_title = "MovieLanez : Adventure Movies";

require_once ('includes/header.php');
require_once ('includes/database.php');

//select statement
$query_str = "SELECT * FROM adventure";
...
if (!$result) {
	...
	<div class="container">
		...
		<nav aria-label="breadcrumb">
			...
			<h1 class="text-center">Adventure Movies</h1>

			<div class="row my-3">
				<div class="col-xs-4 col-xs-offset-8">
					<form action="searchadventure.php" method="get" class="form-inline search-form" role="form">
			...
			while ( $result_row = $result->fetch_assoc() ) :
				...
				<div class="col-sm-4">
					<div class="card" style="width: 18rem;">
						<a href="adventure_details.php?id=<?php echo $result_row['adventure_id']?>">
							<img src="<?php echo $result_row['adventure_img'] ?>" class="card-img-top" alt="..." />
						</a>
						<div class="card-body">
							<p class="card-text">
								<?php
								echo "<a href='adventure_details.php?id=" . $result_row['adventure_id'] . "'>", $result_row['adventure_name'], "</a>";
								?>
							</p>
						</div>
					</div>
	...
	<div class="container my-3 text-center">
		<nav class="example" aria-label="Page navigation example">
			<ul class="pagination">
				<li class="page-item">
				<a class="page-link" href="movies.php" aria-label="Previous">
				...
				<li class="page-item">
				<a class="page-link" href="comedy.php" aria-label="Next">
