	...
	<div class="container wrapper">
		...
		<div class="row">
			<div class="col-xs-6 col-xs-offset-2">
				<form action="createsci_fi_fantasy_review.php" method="get" class="form-horizontal" role="form">
					<input type="hidden" name="sci_fi_fantasy_id" value="<?php echo $sci_fi_fantasy_id; ?>"/>
