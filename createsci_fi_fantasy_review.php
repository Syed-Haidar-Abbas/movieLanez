...
$user_id = $session_id;
$sci_fi_fantasy_id = $_GET['sci_fi_fantasy_id'];
...
//define statement
$query_str = "INSERT INTO sci_fi_fantasy_reviews VALUES (NULL, '$sci_fi_fantasy_id', '$user_id', '$review_rating', '$review_content')";
...
header( "Refresh:3; url=sci_fi_fantasy_details.php?id=$sci_fi_fantasy_id", true, 303);
